...
class TableSupplier extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isEdit: false,
      ...
      <div className="tbl">
        ...
        <Paper className={styles.root}>
          <Table className={styles.table}>
            ...
            <TableBody>
              {this.props.suppliers.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage).map((row, i) => {
                return <TableRowSupplier key={row.Id} row={row} />
              })}
            </TableBody>
            <TableFooter>
              <TableRow>
                <TablePagination
                  ...
                  colSpan={3}
                  count={this.props.suppliers.length}
